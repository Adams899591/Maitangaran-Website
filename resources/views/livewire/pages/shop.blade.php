  ...
  <div class="max-w-7xl mx-auto px-4 py-8 relative">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <div class="md:col-span-9">
        ...
        <!-- Dynamic 4-Product Display Grid -->
        @else
          ...
          <div class="flex items-center justify-center mt-8">
            ...
            <!-- MOBILE VIEW: Ultra-compact (Prev | 1 / 12 | Next) -->
            ...
            <!-- DESKTOP VIEW: Numbered pages with ellipses -->
...
<div wire:init="fetchProducts">
  ...
  <!-- SKELETON LOADER STATE (Shows immediately while API fetch runs) -->
  @if($isLoading && count($products) === 0)
    <x-skeleton-loading-shop/>
  @else
