  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div class="lg:col-span-7 bg-white p-6 sm:p-8 rounded-2xl border border-gray-200 shadow-sm">
        ...
        <form onsubmit="event.preventDefault(); alert('Sorry, your message could not be sent. We are still working on this feature.');" class="space-y-4">
          <!-- Full Name -->
          <div>
          ...
          <button 
            type="submit" 
            class="w-full bg-gray-900 hover:bg-black text-white font-bold text-xs uppercase tracking-wider py-3.5 rounded-xl transition duration-150 shadow-sm"
          >
            Dispatch Message
          </button>
        </form>
