    ...
    >
      <div>
        ...
        <nav class="space-y-1.5">
          ...
          <a href="{{ route('my-review') }}" wire:navigate class="flex items-center gap-3 px-4 py-3 text-sm font-medium {{ request()->routeIs(["my-review", "write-review"]) ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} rounded-lg transition-colors">
