...
<body class="bg-gray-50 m-0 p-0 font-sans antialiased" x-data="{ mobileMenuOpen: false }">
  ...
  <!-- Hero Banner Section (Text First on Mobile/Tablet & Desktop) -->
  <header class="bg-white overflow-hidden border-b border-gray-100">
    <div class="w-full">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 lg:max-w-7xl lg:mx-auto lg:px-8 lg:py-24 items-center">
        ...
        <!-- Text Container: Placed FIRST on both mobile and desktop (order-1) -->
        ...
        <!-- Image Container: Placed SECOND after text (order-2), maintaining edge-to-edge on mobile and proper placement on desktop -->
  ...
  <footer class="bg-black text-gray-300 pt-12 pb-8 mt-16 border-t border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="space-y-4">
          <a class="inline-block no-underline font-extrabold text-white text-xl tracking-wider uppercase" href="../Admin/admin.login.php">
            CARTEVO
          </a>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between border-t border-neutral-900 pt-6 mt-10 gap-4 text-center sm:text-left">
        ...
        <div class="flex items-center space-x-3 bg-neutral-900 px-3 py-1.5 rounded-lg border border-neutral-800">
          <img src="../Icons/Visa.png" alt="Visa" width="36" class="h-auto opacity-80 hover:opacity-100 transition-opacity">
          <img src="../Icons/MasterCard.png" alt="Mastercard" width="36" class="h-auto opacity-80 hover:opacity-100 transition-opacity">
          <img src="../Icons/Paypal.png" alt="PayPal" width="36" class="h-auto opacity-80 hover:opacity-100 transition-opacity">
        </div>
      </div>
